...
class PHPWord_Writer_Word2007_Header extends PHPWord_Writer_Word2007_Base {
	...
	public function writeHeader(PHPWord_Section_Header $header) {
		...
		$objWriter->startElement('w:hdr');
			$objWriter->writeAttribute('xmlns:ve','https://schemas.openxmlformats.org/markup-compatibility/2006');
			$objWriter->writeAttribute('xmlns:o','urn:schemas-microsoft-com:office:office');
			$objWriter->writeAttribute('xmlns:r','https://schemas.openxmlformats.org/officeDocument/2006/relationships');
			$objWriter->writeAttribute('xmlns:m','https://schemas.openxmlformats.org/officeDocument/2006/math');
			$objWriter->writeAttribute('xmlns:v','urn:schemas-microsoft-com:vml');
			$objWriter->writeAttribute('xmlns:wp','https://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing');
			$objWriter->writeAttribute('xmlns:w10','urn:schemas-microsoft-com:office:word');
			$objWriter->writeAttribute('xmlns:w','https://schemas.openxmlformats.org/wordprocessingml/2006/main');
			$objWriter->writeAttribute('xmlns:wne','https://schemas.microsoft.com/office/word/2006/wordml');
