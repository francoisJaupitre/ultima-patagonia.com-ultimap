	...
	public function writeDocumentRels($_relsCollection) {
		...
		$objWriter->writeAttribute('xmlns', 'https://schemas.openxmlformats.org/package/2006/relationships');
			...
			$this->_writeRelationship(
				$objWriter,
				2,
				'https://schemas.openxmlformats.org/officeDocument/2006/relationships/numbering',
				'numbering.xml'
			);
			...
			$this->_writeRelationship(
				$objWriter,
				3,
				'https://schemas.openxmlformats.org/officeDocument/2006/relationships/settings',
				'settings.xml'
			);
			...
			$this->_writeRelationship(
				$objWriter,
				5,
				'https://schemas.openxmlformats.org/officeDocument/2006/relationships/webSettings',
				'webSettings.xml'
			);
			...
			$this->_writeRelationship(
				$objWriter,
				6,
				'https://schemas.openxmlformats.org/officeDocument/2006/relationships/fontTable',
				'fontTable.xml'
			);
			...
			foreach($_relsCollection as $relation) {
				...
				$this->_writeRelationship(
					$objWriter,
					$relationId,
					'https://schemas.openxmlformats.org/officeDocument/2006/relationships/'.$relationType,
					$relationName,
					$targetMode
				);
			}
