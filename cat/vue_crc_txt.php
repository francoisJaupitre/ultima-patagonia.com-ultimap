<table class="lsb w-100">
<?php
$rq_txt = sel_quo("*", "cat_crc_txt", "id_crc", $id, "lgg");
...
?>
							type="text"
							class="website"
							id="crc_txt_titre<?php echo $id_crc_txt ?>"
							placeholder="<?php echo $txt->phtitre->$id_lng; ?>"
							style="width: 100%;"
							value="<?php echo stripslashes(htmlspecialchars($dt_txt['titre'])) ?>"
							onchange="updateData('cat_crc_txt','titre',this.value,<?php echo $id_crc_txt.','.$id ?>);"
						/>
					</td>
				</tr>
				<tr>
