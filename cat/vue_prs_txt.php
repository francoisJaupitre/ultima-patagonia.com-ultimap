...
<?php
	if($aut['cat']) {
?>
		<td class="remove-lgg" id="<?php echo $id_prs_txt ?>">
...
?>
		<td class="txt_lgg">
			<table class="w-100">
				<tr>
					<td class="w-100"><input type="text" <?php if(!$aut['cat']) {echo ' disabled';} ?> id="prs_txt_titre<?php echo $id_prs_txt ?>" placeholder="<?php echo $txt->phtitre->$id_lng; ?>" style="width: 100%;" value="<?php echo stripslashes(htmlspecialchars($dt_txt['titre'])) ?>" onchange="updateData('cat_prs_txt','titre',this.value,<?php echo $id_prs_txt.','.$id ?>);" /></td>
				</tr>
				<tr>
					<td>
