				...
				<td class="w-100">
					<div style="float:right; padding-left: 5px;">
						...
						<span class="vatdib">
							...
							<input type="number" <?php if(!$aut['cat']) {echo ' disabled';} ?> style="width: 40px;" value="<?php echo stripslashes($dt_chm['nbr']) ?>" onChange="updateData('cat_hbr_chm','nbr',this.value,<?php echo $id_chm ?>)" />
							<strong><?php echo $txt->cpc->$id_lng.' :'; ?></strong>
							<input type="number" <?php if(!$aut['cat']) {echo ' disabled';} ?> style="width: 40px;" value="<?php echo stripslashes($dt_chm['cpc']) ?>" onChange="updateData('cat_hbr_chm','cpc',this.value,<?php echo $id_chm ?>)" />
						</span>
					</div>
					<div class="div_cat">
						<div style="float:left; padding-right: 5px;">
							<strong><?php echo $txt->chm->$id_lng.' :'; ?></strong>
							<input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> value="<?php echo stripslashes($dt_chm['nom']) ?>" onChange="updateData('cat_hbr_chm','nom',this.value,<?php echo $id_chm.','.$id ?>)" />
							<strong><?php echo $txt->infos->$id_lng.' :'; ?></strong>
						</div>
						<div class="div_cat"><input type="text" <?php if(!$aut['cat']) {echo ' disabled';} ?> style="width: 100%;" value="<?php echo stripslashes($dt_chm['info']) ?>" onChange="updateData('cat_hbr_chm','info',this.value,<?php echo $id_chm ?>)" /></div>
					</div>
				</td>
				<td>
<!--COMMANDES-->
...
<?php
	if($aut['cat'] and !$vrl) {
?>
								<li onclick="duplicate('chm',<?php echo $id_chm ?>);"><?php echo $txt->cop->$id_lng; ?></li>
<?php
	}
	if($aut['cat'] and !$vrl) {
?>
...
?>
			<tr>
				<td class="td"><input <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> type="checkbox" autocomplete="off" <?php if ($dt_trf['def']) {echo('checked="checked"');} ?> onclick="if(this.checked) {updateData('cat_hbr_chm_trf','def','1',<?php echo $id_trf ?>,<?php echo $id ?>)}else{updateData('cat_hbr_chm_trf','def','0',<?php echo $id_trf ?>,<?php echo $id ?>)};" /></td>
				<td>
					<table>
<?php
...
?>
				...
				<td class="td"><input <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="hbr_chm_trf_est<?php echo $id_trf; ?>" type="checkbox" autocomplete="off" <?php if ($dt_trf['est']) {echo('checked="checked"');} ?> onclick="if(this.checked) {updateData('cat_hbr_chm_trf','est','1',<?php echo $id_trf ?>);document.getElementById('hbr_chm_trf_sg_rck<?php echo $id_trf; ?>').style.backgroundColor ='gold';document.getElementById('hbr_chm_trf_sg_net<?php echo $id_trf; ?>').style.backgroundColor ='gold';document.getElementById('hbr_chm_trf_db_rck<?php echo $id_trf; ?>').style.backgroundColor ='gold';document.getElementById('hbr_chm_trf_db_net<?php echo $id_trf; ?>').style.backgroundColor ='gold';document.getElementById('hbr_chm_trf_tp_rck<?php echo $id_trf; ?>').style.backgroundColor ='gold';document.getElementById('hbr_chm_trf_tp_net<?php echo $id_trf; ?>').style.backgroundColor ='gold';document.getElementById('hbr_chm_trf_qd_rck<?php echo $id_trf; ?>').style.backgroundColor ='gold';document.getElementById('hbr_chm_trf_qd_net<?php echo $id_trf; ?>').style.backgroundColor ='gold';}else{updateData('cat_hbr_chm_trf','est','0',<?php echo $id_trf ?>);document.getElementById('hbr_chm_trf_sg_rck<?php echo $id_trf; ?>').style.backgroundColor ='white';document.getElementById('hbr_chm_trf_sg_net<?php echo $id_trf; ?>').style.backgroundColor ='white';document.getElementById('hbr_chm_trf_db_rck<?php echo $id_trf; ?>').style.backgroundColor ='white';document.getElementById('hbr_chm_trf_db_net<?php echo $id_trf; ?>').style.backgroundColor ='white';document.getElementById('hbr_chm_trf_tp_rck<?php echo $id_trf; ?>').style.backgroundColor ='white';document.getElementById('hbr_chm_trf_tp_net<?php echo $id_trf; ?>').style.backgroundColor ='white';document.getElementById('hbr_chm_trf_qd_rck<?php echo $id_trf; ?>').style.backgroundColor ='white';document.getElementById('hbr_chm_trf_qd_net<?php echo $id_trf; ?>').style.backgroundColor ='white';};" /></td>
				<td class="td"><input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="hbr_chm_trf_sg_rck<?php echo $id_trf; ?>" class="w52" style="<?php if($dt_trf['sg_rck']!=0 and ($dt_trf['sg_net']==0 or $dt_trf['sg_net']>$dt_trf['sg_rck'])) {echo 'background-color: tomato';} elseif($dt_trf['est']) {echo'background-color: gold';} ?>" value="<?php echo number_format($dt_trf['sg_rck'],$prm_crr_dcm[$dt_trf['crr']],'.','') ?>" onChange="updateData('cat_hbr_chm_trf','sg_rck',this.value,<?php echo $id_trf ?>);" /></td>
				<td class="td"><input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="hbr_chm_trf_sg_net<?php echo $id_trf; ?>" class="w52" style="<?php if($dt_trf['sg_rck']!=0 and ($dt_trf['sg_net']==0 or $dt_trf['sg_net']>$dt_trf['sg_rck'])) {echo 'background-color: tomato';} elseif($dt_trf['est']) {echo'background-color: gold';} ?>" value="<?php echo number_format($dt_trf['sg_net'],$prm_crr_dcm[$dt_trf['crr']],'.','') ?>" onChange="updateData('cat_hbr_chm_trf','sg_net',this.value,<?php echo $id_trf ?>);" /></td>
				<td class="td"><input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="hbr_chm_trf_db_rck<?php echo $id_trf; ?>" class="w52" style="<?php if($dt_trf['db_rck']!=0 and ($dt_trf['db_net']==0 or $dt_trf['db_net']>$dt_trf['db_rck'])) {echo 'background-color: tomato';} elseif($dt_trf['est']) {echo'background-color: gold';} ?>" value="<?php echo number_format($dt_trf['db_rck'],$prm_crr_dcm[$dt_trf['crr']],'.','') ?>" onChange="updateData('cat_hbr_chm_trf','db_rck',this.value,<?php echo $id_trf ?>);" /></td>
				<td class="td"><input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="hbr_chm_trf_db_net<?php echo $id_trf; ?>" class="w52" style="<?php if($dt_trf['db_rck']!=0 and ($dt_trf['db_net']==0 or $dt_trf['db_net']>$dt_trf['db_rck'])) {echo 'background-color: tomato';} elseif($dt_trf['est']) {echo'background-color: gold';} ?>" value="<?php echo number_format($dt_trf['db_net'],$prm_crr_dcm[$dt_trf['crr']],'.','') ?>" onChange="updateData('cat_hbr_chm_trf','db_net',this.value,<?php echo $id_trf ?>);" /></td>
				<td class="td"><input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="hbr_chm_trf_tp_rck<?php echo $id_trf; ?>" class="w52" style="<?php if($dt_trf['tp_rck']!=0 and ($dt_trf['tp_net']==0 or $dt_trf['tp_net']>$dt_trf['tp_rck'])) {echo 'background-color: tomato';} elseif($dt_trf['est']) {echo'background-color: gold';} ?>" value="<?php echo number_format($dt_trf['tp_rck'],$prm_crr_dcm[$dt_trf['crr']],'.','') ?>" onChange="updateData('cat_hbr_chm_trf','tp_rck',this.value,<?php echo $id_trf ?>);" /></td>
				<td class="td"><input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="hbr_chm_trf_tp_net<?php echo $id_trf; ?>" class="w52" style="<?php if($dt_trf['tp_rck']!=0 and ($dt_trf['tp_net']==0 or $dt_trf['tp_net']>$dt_trf['tp_rck'])) {echo 'background-color: tomato';} elseif($dt_trf['est']) {echo'background-color: gold';} ?>" value="<?php echo number_format($dt_trf['tp_net'],$prm_crr_dcm[$dt_trf['crr']],'.','') ?>" onChange="updateData('cat_hbr_chm_trf','tp_net',this.value,<?php echo $id_trf ?>);" /></td>
				<td class="td"><input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="hbr_chm_trf_qd_rck<?php echo $id_trf; ?>" class="w52" style="<?php if($dt_trf['qd_rck']!=0 and ($dt_trf['qd_net']==0 or $dt_trf['qd_net']>$dt_trf['qd_rck'])) {echo 'background-color: tomato';} elseif($dt_trf['est']) {echo'background-color: gold';} ?>" value="<?php echo number_format($dt_trf['qd_rck'],$prm_crr_dcm[$dt_trf['crr']],'.','') ?>" onChange="updateData('cat_hbr_chm_trf','qd_rck',this.value,<?php echo $id_trf ?>);" /></td>
				<td class="td"><input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="hbr_chm_trf_qd_net<?php echo $id_trf; ?>" class="w52" style="<?php if($dt_trf['qd_rck']!=0 and ($dt_trf['qd_net']==0 or $dt_trf['qd_net']>$dt_trf['qd_rck'])) {echo 'background-color: tomato';} elseif($dt_trf['est']) {echo'background-color: gold';} ?>" value="<?php echo number_format($dt_trf['qd_net'],$prm_crr_dcm[$dt_trf['crr']],'.','') ?>" onChange="updateData('cat_hbr_chm_trf','qd_net',this.value,<?php echo $id_trf ?>);" /></td>
<?php
		if($aut['cat'] and !$vrl) {
?>
