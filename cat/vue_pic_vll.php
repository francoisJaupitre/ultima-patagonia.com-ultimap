...
?>
	...
	<div id="sel_vll" class="cmd mw200">
		<div><input type="text" id="ipt_sel_vll" onkeyup="auto_lst('pic<?php echo $id ?>','vll',this.value,event);" /></div>
...
<span class="dib">
	...
	<div id="sel_jrn" class="cmd mw200">
		<div><input type="text" id="ipt_sel_jrn" onkeyup="auto_lst('pic<?php echo $id_vll ?>','jrn',this.value,event);" /></div>
