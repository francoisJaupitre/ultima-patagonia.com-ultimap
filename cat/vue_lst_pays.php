...
?>
	<li id="enter_pays" style="background-color: Chocolate;" onClick="maj('cat_<?php echo $cbl ?>','id_pays','0',<?php echo $id ?>);"><?php echo $txt->nodef->$id_lng; ?></li>
<?php	
	$flg_enter = false;
}
...
?>
	<li <?php if($flg_enter) {echo 'id="enter_pays" style="background-color: Chocolate;"';} ?>  onClick="maj('cat_<?php echo $cbl ?>','id_pays',<?php echo $pays_id.','.$id ?>);"><?php echo $nom; ?></li>
<?php
		$flg_enter = false;
	}
}
