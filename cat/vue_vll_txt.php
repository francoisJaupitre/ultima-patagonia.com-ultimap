				...
				<tr>
					<td>
						<div style="position: relative;">
							...
							<div id="vll_txt_dsc<?php echo $dt_txt['lgg'] ?>" class="ust rich" <?php if($aut['cat']) { ?> onclick="richtext(this.id,'cat_vll_txt','dsc',<?php echo $id_vll_txt ?>);this.onclick=null;" <?php } ?> ><?php echo nl2br(stripslashes($dt_txt['dsc'])) ?></div>
