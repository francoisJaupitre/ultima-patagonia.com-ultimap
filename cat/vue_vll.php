		...
		<table style="padding: 0px 5px;" class="w-100">
				...
				<td class="vat">
					<table class="dsg w-100">
						<tr>
							...
							<td class="w-100"><input type="text" <?php if(!$aut['cat']) {echo ' disabled';} ?> id="nom_vll" style="min-width: 150px;" value="<?php echo stripslashes($dt_vll['nom']) ?>" onChange="maj('cat_vll','nom',this.value,<?php echo $id ?>);" /></td>
						</tr>
						<tr>
			...
			<tr>
				...
				<td class="vat w-100" class="tbl_prs">
					<input type="text" id="vll_lat<?php echo $id ?>" <?php if(!$aut['cat']) {echo ' disabled';} ?> style="width: 60px" value="<?php echo $dt_vll['lat']; ?>" onChange="maj('cat_vll','lat',this.value,<?php echo $id.',0' ?>);">(N+/S-)<br/>
					<input type="text" id="vll_lon<?php echo $id ?>" <?php if(!$aut['cat']) {echo ' disabled';} ?> style="width: 60px" value="<?php echo $dt_vll['lon']; ?>" onChange="maj('cat_vll','lon',this.value,<?php echo $id.',0' ?>);">(E+/W-)
