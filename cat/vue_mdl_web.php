...
?>
	<button onclick="
			insertWebsite('mdl','<?php echo $dt_txt['web_uid'] ?>',<?php echo $dt_txt['id']; ?>,'<?php echo $dt_txt['lgg'] ?>','<?php echo $lgg[$dt_txt['lgg']] ?>');
			document.getElementById('vue_cmd_mdl<?php echo $id ?>').style.display='none';
		"
	>
<?php
