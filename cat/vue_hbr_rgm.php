...
?>
			<tr>
				<td class="td"><input <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> type="checkbox" autocomplete="off" <?php if ($dt_trf['def']) {echo('checked="checked"');} ?> onclick="if(this.checked) {maj('cat_hbr_rgm_trf','def','1',<?php echo $id_trf ?>,<?php echo $id ?>)}else{maj('cat_hbr_rgm_trf','def','0',<?php echo $id_trf ?>,<?php echo $id ?>)};" /></td>
				<td>
					<table>
<?php
...
?>
				...
				<td class="td"><input <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="hbr_rgm_trf_est<?php echo $id_trf; ?>" type="checkbox" autocomplete="off" <?php if ($dt_trf['est']) {echo('checked="checked"');} ?> onclick="if(this.checked) {maj('cat_hbr_rgm_trf','est','1',<?php echo $id_trf ?>);document.getElementById('hbr_rgm_trf_sg_rck<?php echo $id_trf; ?>').style.backgroundColor ='gold';document.getElementById('hbr_rgm_trf_sg_net<?php echo $id_trf; ?>').style.backgroundColor ='gold';document.getElementById('hbr_rgm_trf_db_rck<?php echo $id_trf; ?>').style.backgroundColor ='gold';document.getElementById('hbr_rgm_trf_db_net<?php echo $id_trf; ?>').style.backgroundColor ='gold';document.getElementById('hbr_rgm_trf_tp_rck<?php echo $id_trf; ?>').style.backgroundColor ='gold';document.getElementById('hbr_rgm_trf_tp_net<?php echo $id_trf; ?>').style.backgroundColor ='gold';document.getElementById('hbr_rgm_trf_qd_rck<?php echo $id_trf; ?>').style.backgroundColor ='gold';document.getElementById('hbr_rgm_trf_qd_net<?php echo $id_trf; ?>').style.backgroundColor ='gold';}else{maj('cat_hbr_rgm_trf','est','0',<?php echo $id_trf ?>);document.getElementById('hbr_rgm_trf_sg_rck<?php echo $id_trf; ?>').style.backgroundColor ='white';document.getElementById('hbr_rgm_trf_sg_net<?php echo $id_trf; ?>').style.backgroundColor ='white';document.getElementById('hbr_rgm_trf_db_rck<?php echo $id_trf; ?>').style.backgroundColor ='white';document.getElementById('hbr_rgm_trf_db_net<?php echo $id_trf; ?>').style.backgroundColor ='white';document.getElementById('hbr_rgm_trf_tp_rck<?php echo $id_trf; ?>').style.backgroundColor ='white';document.getElementById('hbr_rgm_trf_tp_net<?php echo $id_trf; ?>').style.backgroundColor ='white';document.getElementById('hbr_rgm_trf_qd_rck<?php echo $id_trf; ?>').style.backgroundColor ='white';document.getElementById('hbr_rgm_trf_qd_net<?php echo $id_trf; ?>').style.backgroundColor ='white';};" /></td>
				<td class="td"><input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="hbr_rgm_trf_sg_rck<?php echo $id_trf; ?>" class="w52" style="<?php if($dt_trf['sg_rck']!=0 and ($dt_trf['sg_net']==0 or $dt_trf['sg_net']>$dt_trf['sg_rck'])) {echo 'background-color: tomato';} elseif($dt_trf['est']) {echo'background-color: gold';} ?>" value="<?php echo number_format($dt_trf['sg_rck'],$prm_crr_dcm[$dt_trf['crr']],'.','') ?>" onChange="maj('cat_hbr_rgm_trf','sg_rck',this.value,<?php echo $id_trf ?>);" /></td>
				<td class="td"><input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="hbr_rgm_trf_sg_net<?php echo $id_trf; ?>" class="w52" style="<?php if($dt_trf['sg_rck']!=0 and ($dt_trf['sg_net']==0 or $dt_trf['sg_net']>$dt_trf['sg_rck'])) {echo 'background-color: tomato';} elseif($dt_trf['est']) {echo'background-color: gold';} ?>" value="<?php echo number_format($dt_trf['sg_net'],$prm_crr_dcm[$dt_trf['crr']],'.','') ?>" onChange="maj('cat_hbr_rgm_trf','sg_net',this.value,<?php echo $id_trf ?>);" /></td>
				<td class="td"><input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="hbr_rgm_trf_db_rck<?php echo $id_trf; ?>" class="w52" style="<?php if($dt_trf['db_rck']!=0 and ($dt_trf['db_net']==0 or $dt_trf['db_net']>$dt_trf['db_rck'])) {echo 'background-color: tomato';} elseif($dt_trf['est']) {echo'background-color: gold';} ?>" value="<?php echo number_format($dt_trf['db_rck'],$prm_crr_dcm[$dt_trf['crr']],'.','') ?>" onChange="maj('cat_hbr_rgm_trf','db_rck',this.value,<?php echo $id_trf ?>);" /></td>
				<td class="td"><input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="hbr_rgm_trf_db_net<?php echo $id_trf; ?>" class="w52" style="<?php if($dt_trf['db_rck']!=0 and ($dt_trf['db_net']==0 or $dt_trf['db_net']>$dt_trf['db_rck'])) {echo 'background-color: tomato';} elseif($dt_trf['est']) {echo'background-color: gold';} ?>" value="<?php echo number_format($dt_trf['db_net'],$prm_crr_dcm[$dt_trf['crr']],'.','') ?>" onChange="maj('cat_hbr_rgm_trf','db_net',this.value,<?php echo $id_trf ?>);" /></td>
				<td class="td"><input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="hbr_rgm_trf_tp_rck<?php echo $id_trf; ?>" class="w52" style="<?php if($dt_trf['tp_rck']!=0 and ($dt_trf['tp_net']==0 or $dt_trf['tp_net']>$dt_trf['tp_rck'])) {echo 'background-color: tomato';} elseif($dt_trf['est']) {echo'background-color: gold';} ?>" value="<?php echo number_format($dt_trf['tp_rck'],$prm_crr_dcm[$dt_trf['crr']],'.','') ?>" onChange="maj('cat_hbr_rgm_trf','tp_rck',this.value,<?php echo $id_trf ?>);" /></td>
				<td class="td"><input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="hbr_rgm_trf_tp_net<?php echo $id_trf; ?>" class="w52" style="<?php if($dt_trf['tp_rck']!=0 and ($dt_trf['tp_net']==0 or $dt_trf['tp_net']>$dt_trf['tp_rck'])) {echo 'background-color: tomato';} elseif($dt_trf['est']) {echo'background-color: gold';} ?>" value="<?php echo number_format($dt_trf['tp_net'],$prm_crr_dcm[$dt_trf['crr']],'.','') ?>" onChange="maj('cat_hbr_rgm_trf','tp_net',this.value,<?php echo $id_trf ?>);" /></td>
				<td class="td"><input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="hbr_rgm_trf_qd_rck<?php echo $id_trf; ?>" class="w52" style="<?php if($dt_trf['qd_rck']!=0 and ($dt_trf['qd_net']==0 or $dt_trf['qd_net']>$dt_trf['qd_rck'])) {echo 'background-color: tomato';} elseif($dt_trf['est']) {echo'background-color: gold';} ?>" value="<?php echo number_format($dt_trf['qd_rck'],$prm_crr_dcm[$dt_trf['crr']],'.','') ?>" onChange="maj('cat_hbr_rgm_trf','qd_rck',this.value,<?php echo $id_trf ?>);" /></td>
				<td class="td"><input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="hbr_rgm_trf_qd_net<?php echo $id_trf; ?>" class="w52" style="<?php if($dt_trf['qd_rck']!=0 and ($dt_trf['qd_net']==0 or $dt_trf['qd_net']>$dt_trf['qd_rck'])) {echo 'background-color: tomato';} elseif($dt_trf['est']) {echo'background-color: gold';} ?>" value="<?php echo number_format($dt_trf['qd_net'],$prm_crr_dcm[$dt_trf['crr']],'.','') ?>" onChange="maj('cat_hbr_rgm_trf','qd_net',this.value,<?php echo $id_trf ?>);" /></td>
<?php
		if($aut['cat'] and !$vrl) {
?>
