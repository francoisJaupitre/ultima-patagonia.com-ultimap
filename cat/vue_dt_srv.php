...
?>
			...
			<td class="td td_bss<?php echo $id_bss; ?>">
				<input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="srv_trf_bss_trf_rck<?php echo $id_bss; ?>" class="w52 ipt_srv_trf<?php echo $id_trf; ?>" style="<?php if($trf_rck!=0 and ($trf_net==0 or $trf_net>$trf_rck)) {echo 'background-color: tomato';} elseif($dt_bss[$n]['est']) {echo'background-color: gold';} ?>" value="<?php echo number_format($trf_rck,$prm_crr_dcm[$dt_trf['crr']],'.','') ?>"
			...
			<td class="td td_bss<?php echo $id_bss; ?>">
				<input type="text" <?php if(!$aut['cat'] or $vrl) {echo ' disabled';} ?> id="srv_trf_bss_trf_net<?php echo $id_bss; ?>" class="w52 ipt_srv_trf<?php echo $id_trf; ?>" style="<?php if($trf_rck!=0 and ($trf_net==0 or $trf_net>$trf_rck)) {echo 'background-color: tomato';} elseif($dt_bss[$n]['est']) {echo'background-color: gold';} ?>" value="<?php echo number_format($trf_net,$prm_crr_dcm[$dt_trf['crr']],'.','') ?>"
