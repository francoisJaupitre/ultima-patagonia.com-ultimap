...
?>
		...
		<td class="text-center" onclick="ajt('crc');"><img src="../prm/img/ajt.png"/></td>
<?php
		break;
case 'mdl':
  include("../cfg/rgn.php");
...
?>
  ...
  <td class="text-center" onclick="ajt('mdl');"><img src="../prm/img/ajt.png" /></td>
<?php
  break;
case 'jrn':
  include("../cfg/vll.php");
...
?>
  ...
  <td class="text-center" onclick="ajt('jrn');"><img src="../prm/img/ajt.png"/></td>
<?php
  break;
case 'prs':
  include("../prm/lgg.php");
...
?>
  ...
  <td class="text-center" onclick="ajt('prs');"><img src="../prm/img/ajt.png"/></td>
<?php
  break;
case 'srv':
  include("../prm/lgg.php");
...
?>
  ...
  <td class="text-center" onclick="ajt('srv');"><img src="../prm/img/ajt.png"/></td>
<?php
  break;
case 'hbr':
  include("../prm/lgg.php");
...
?>
  ...
  <td class="text-center" onclick="ajt('hbr');"><img src="../prm/img/ajt.png" /></td>
<?php
  break;
case 'clt':
...
?>
  ...
  <td class="text-center" onclick="ajt('clt');"><img src="../prm/img/ajt.png" /></td>
<?php
  break;
case 'frn':
  include("../prm/lgg.php");
...
?>
	...
	<td class='tbl'><?php echo $txt->lst->cat->nvtrf->$id_lng; ?></td>
  <td class="text-center" onclick="ajt('frn');"><img src="../prm/img/ajt.png" /></td>
<?php
  break;
case 'pic':
  include("../cfg/rgn.php");
...
?>
  ...
  <td class="text-center" onclick="ajt('rgn');"><img src="../prm/img/ajt.png" /></td>
<?php
  break;
case 'vll':
  include("../cfg/rgn.php");
...
?>
  ...
  <td class="text-center" onclick="ajt('vll');"><img src="../prm/img/ajt.png" /></td>
<?php
  break;
case 'lieu':
  include("../cfg/vll.php");
...
?>
  ...
  <td class="text-center" onclick="ajt('lieu');"><img src="../prm/img/ajt.png" /></td>
<?php
  break;
case 'bnq':
	include("../prm/lgg.php");
...
?>
  ...
  <td class="text-center" onclick="ajt('bnq');"><img src="../prm/img/ajt.png" /></td>
<?php
  break;
}
?>
