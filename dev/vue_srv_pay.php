...
?>
	<tr>
		...
		<td><input type="text" <?php if(!$aut['res']){echo ' disabled';} ?> id="srv_pay_liq<?php echo $id_srv_pay; ?>" style="width: 45px;" value="<?php echo number_format($dt_srv_pay['liq'],$prm_crr_dcm[$dt_srv_pay['crr']],'.','') ?>" onChange="maj('dev_srv_pay','liq',this.value,<?php echo $id_srv_pay ?>)" /></td>
...
?>
		<input type="text" <?php if(!$aut['res']){echo ' disabled';} ?> id="srv_pay_taux<?php echo $id_srv_pay; ?>" style="width: 45px;" value="<?php echo number_format($dt_srv_pay['taux'],$cfg_crr_dcm[$dt_srv_pay['crr']],'.','') ?>" onChange="maj('dev_srv_pay','taux',this.value,<?php echo $id_srv_pay ?>)" />
<?php
	}
?>
		</td>
