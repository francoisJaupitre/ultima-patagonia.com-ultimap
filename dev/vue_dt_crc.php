...
if(isset($_POST['id_dev_crc']))
{
	...
	{
		$mdl_datas[$dt_mdl['id']]['id_cat'] = $dt_mdl['id_cat'];
...
<div id="div_mdl<?php echo $id_dev_mdl ?>">
	<div class="tbl_crc">
		<table class="w-100">
			<tr
				id="vue_ttr_mdl_<?php echo $id_dev_mdl ?>"
<?php
			if($id_cat_mdl > 0)
			{
				echo 'class="up_mdl'.$id_cat_mdl.'"';
			}
?>
			>
<?php
			include("vue_ttr_mdl.php");
?>
			</tr>
			<tr
				id="vue_trf_mdl_<?php echo $id_dev_mdl ?>">
<?php
			include("vue_trf_mdl.php");
?>
			</tr>
		</table>
		<div
			id="vue_dsc_rmn_dt_end_mdl_<?php echo $id_dev_mdl ?>"
		>
<?php
			include("vue_dsc_rmn_dt_end_mdl.php");
?>
		</div>
	</div>
	<br />
