...
$dt_mdl = ftc_ass(sel_quo("ord,fus","dev_mdl","id",$id_dev_mdl));
if($dt_mdl['fus']==1 and $nb_j>0){
	upd_noq('dev_crc','duree','duree+1',$id_dev_crc);
	$nb_j--;
}
$ord_mdl = $dt_mdl['ord'];
$rq_mdl = sel_quo("id,ord,fus","dev_mdl","id_crc",$id_dev_crc,"ord");
...
$rq = sel_quo("id","dev_mdl_rmn","id_mdl",$id_dev_mdl);
