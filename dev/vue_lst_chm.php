...
if(substr(upnoac($txt->creer->$id_lng),0,strlen($src))==$src){
	$event = "ajt_hbr(".$id_hbr.",0,".$id_vll.",".$id_rgm.",".$id_dev_hbr.",".$id_dev_prs.",1);src_hbr(".$id_hbr.",0,".$id_vll.",".$id_rgm.",".$id_dev_hbr.",".$id_dev_prs.",'ajt');";
?>
...
if(($cbl=='prs' or $cbl=='hbr_opt') and substr(upnoac($txt->nodef->$id_lng),0,strlen($src))==$src){
	$event = "ajt_hbr(".$id_hbr.",-1,".$id_vll.",".$id_rgm.",".$id_dev_hbr.",".$id_dev_prs.",1);src_hbr(".$id_hbr.",-1,".$id_vll.",".$id_rgm.",".$id_dev_hbr.",".$id_dev_prs.",'ajt');"
?>
...
if(substr(upnoac($txt->libre->$id_lng),0,strlen($src))==$src){
	$event = "ajt_hbr(".$id_hbr.",-2,".$id_vll.",".$id_rgm.",".$id_dev_hbr.",".$id_dev_prs.",1);src_hbr(".$id_hbr.",-2,".$id_vll.",".$id_rgm.",".$id_dev_hbr.",".$id_dev_prs.",'ajt');";
?>
...
while($dt_lst_chm = ftc_ass($rq_lst_chm)){
	if(substr(upnoac($dt_lst_chm['nom']),0,strlen($src))==$src){
		$event = "ajt_hbr(".$id_hbr.",".$dt_lst_chm['id'].",".$id_vll.",".$id_rgm.",".$id_dev_hbr.",".$id_dev_prs.",1); src_hbr(".$id_hbr.",".$dt_lst_chm['id'].",".$id_vll.",".$id_rgm.",".$id_dev_hbr.",".$id_dev_prs.",'ajt');";
?>
