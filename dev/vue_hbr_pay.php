...
?>
	<tr>
		...
		<td><input type="text" <?php if(!$aut['res']){echo ' disabled';} ?> id="hbr_pay_liq<?php echo $id_hbr_pay; ?>" style="width: 45px;" value="<?php echo number_format($dt_hbr_pay['liq'],$prm_crr_dcm[$dt_hbr_pay['crr']],'.','') ?>" onChange="maj('dev_hbr_pay','liq',this.value,<?php echo $id_hbr_pay ?>)" /></td>
...
?>
		<input type="text" <?php if(!$aut['res']){echo ' disabled';} ?> id="hbr_pay_taux<?php echo $id_hbr_pay; ?>" style="width: 45px;" value="<?php echo number_format($dt_hbr_pay['taux'],$cfg_crr_dcm[$dt_hbr_pay['crr']],'.','') ?>" onChange="maj('dev_hbr_pay','taux',this.value,<?php echo $id_hbr_pay ?>)" />
<?php
	}
?>
		</td>
