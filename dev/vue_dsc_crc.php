...
<td class="lsb" style="text-align: center;">
	...
	<div style="margin-left: 105px; margin-right: 5px; position: relative;">
		...
		<div id="crc_dsc" class="ust rich" <?php if(($aut['dev'] and $cnf<1) or ($aut['res'] and $cnf>0)){ ?> onclick="richtext(this.id,'dev_crc','dsc',<?php echo $id_dev_crc ?>);this.onclick=null;" <?php } ?> ><?php echo nl2br(stripslashes($dsc_crc)) ?></div>
